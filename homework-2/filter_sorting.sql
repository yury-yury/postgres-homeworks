...
SELECT * FROM orders WHERE ship_country IN ('France', 'Germany', 'Spain') LIMIT 50;
SELECT * FROM orders WHERE ship_country IN ('France', 'Germany', 'Spain') LIMIT 50 OFFSET 50;
SELECT * FROM orders WHERE ship_country IN ('France', 'Germany', 'Spain') LIMIT 50 OFFSET 100;
SELECT * FROM orders WHERE ship_country IN ('France', 'Germany', 'Spain') LIMIT 50 OFFSET 150;
SELECT * FROM orders WHERE ship_country IN ('France', 'Germany', 'Spain') LIMIT 50 OFFSET 200;
...
SELECT DISTINCT ship_city, ship_country FROM orders ORDER BY ship_country, ship_city LIMIT 50;
SELECT DISTINCT ship_city, ship_country FROM orders ORDER BY ship_country, ship_city LIMIT 50 OFFSET 50;
...
SELECT AVG(shipped_date - order_date) AS delivery_time FROM orders WHERE ship_country = 'Germany';
